...
import com.example.studymanagement.Components.CheckBox
import com.example.studymanagement.Components.DeleteDialogue
import com.example.studymanagement.Components.SubjectListSheet
import com.example.studymanagement.Components.TaskDatePicker
...
private fun TaskScreen(
    ...
    var isDeleteDialogue by rememberSaveable { mutableStateOf(false) }

    var isDatePickerDialogueOpen by rememberSaveable { mutableStateOf(false) }
    ...
    var isBottomSheetState by remember{ mutableStateOf(false) }
...
//    var description by remember { mutableStateOf("") }
    ...
    taskTitleError = when{
        ...
        state.title.length < 4 -> "Task title is too small."
        state.title.length > 30 -> "Task title is too large."
        else -> null
    }
    ...
    DeleteDialogue(
        ...
        Title = "Delete Task?",
        bodyText = "Are you sure, you want to delete this task? This cannot be undone",
        onDismissRequest = { isDeleteDialogue = false },
        onConfirmButtonClick = {
            onEvent(TaskEvent.DeleteTask)
            isDeleteDialogue = false
        }
    )
    ...
    SubjectListSheet(
        ...
        onDismissRequest = { isBottomSheetState = false },
        onSubjectCicked = { subject ->
            scope.launch { sheetState.hide()}.invokeOnCompletion {
                if(!sheetState.isVisible) isBottomSheetState = false
            }
    ...
    Scaffold (
        ...
        topBar = {
            TaskScreenTopBar(
                ...
                onDeleteButtonClick = { isDeleteDialogue = true },
            ...
            )
        {
            ...
            Row(
                ...
                IconButton(onClick = { isBottomSheetState = true }) {
                    Icon(
