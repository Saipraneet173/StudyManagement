...
//These colour values were obtained from "https://m3.material.io/theme-builder#/custom" website
...
val Yellow = Color(0xFFF9DB22)

// Custom made gradients for the app
val gradient1 = listOf(Color(0xFFad5390), Color(0xFF3c1058))
val gradient2 = listOf(Color(0xFF3A6067), Color(0xFF16222A))
val gradient3 = listOf(Color(0xFFF85800), Color(0xFFFF5989))
val gradient4 = listOf(Color(0xFF00c2cd), Color(0xFF3a7ac4))
val gradient5 = listOf(Color(0xFF99f2c8), Color(0xFF1f4022))
