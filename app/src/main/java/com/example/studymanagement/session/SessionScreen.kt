...
@Destination(
    deepLinks = [
        DeepLink(
            ...
            uriPattern = "study_manager://dashboard/StudySession"
        )
    ]
)
@Composable
...
private fun SessionScreen(
    ...
    // fetching the subject name using the subject ID.
    ...
    TopAppBar(
        navigationIcon = {
            IconButton(onClick = onBackButtonClick) {
                Icon(imageVector = Icons.Default.ArrowBack, contentDescription = "Navigation back to screen")
            }
        },
        title = {
