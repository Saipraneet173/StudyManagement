            ...
            LazyColumn(
                ...
                items(subjects){subjects->
                    Box(
                        modifier = Modifier
                            .fillMaxWidth()
                            .clickable { onSubjectCicked(subjects) }
                            .padding(8.dp)
                    ){
                ...
                if(subjects.isEmpty()){
                    item{
                        Text(modifier = Modifier.padding(10.dp), text = "Ready to begin? First , add a subject")
                    }
                }
            }
        }
